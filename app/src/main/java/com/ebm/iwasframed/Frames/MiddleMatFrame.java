...
/**
 * Created by Usman on 1/11/2018.
 */

public class MiddleMatFrame extends AppCompatImageView {
    ...
    boolean tripleMat=false, doubleMat=false;
    double offset=0, tripleOffset=0;
    SharedPreferences sharedPreferences = getContext().getSharedPreferences("Params", Context.MODE_PRIVATE);
    SharedPreferences.Editor edt=sharedPreferences.edit();
    public MiddleMatFrame(Context context) {
        super(context);
        paint = new Paint();
    ...
    public MiddleMatFrame(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MiddleMatFrame(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if(tripleMat){
            ...
            if (width != 0) {
                drawTextinSide(imageTextWidth, imageTextHeight,
